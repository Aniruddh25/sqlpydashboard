...
#c.JupyterHub.data_files_path = '/opt/microsoft/mlserver/9.3.0/runtime/python/share/jupyter/hub'
...
#  documentation for your spawner to verify!
c.Spawner.cmd = ['/opt/microsoft/mlserver/9.3.0/runtime/python/bin/jupyterhub-singleuser']
...
# c.Spawner.notebook_dir = '/tmp/notebooks/'
...
origin = 'http://sqlserverml.blob.core.windows.net'
c.Spawner.args = ['--NotebookApp.allow_origin={origin}'.format(origin=origin), '--NotebookApp.allow_credentials=True']
c.JupyterHub.tornado_settings = { 
    'headers': { 
